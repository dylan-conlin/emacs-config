...
(custom-theme-set-faces
 ...
 '(fringe ((((class color) (min-colors 89)) (:background "#f7f7f7"))))
 '(highlight ((((class color) (min-colors 89)) (:foreground "#0072b2" :background "#e5e5e5"))))
 '(region ((((class color) (min-colors 89)) (:foreground unspecified :background "#f8ec59"))))
 '(secondary-selection ((((class color) (min-colors 89)) (:background "#e5e5e5"))))
 '(isearch ((((class color) (min-colors 89)) (:foreground "white" :background "white"))))
 ...
 '(font-lock-comment-face ((t (:foreground "#848ea9" :slant italic))))
 ...
 '(font-lock-string-face ((t (:foreground "#009e73"))))
