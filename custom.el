...
(custom-set-faces
 ...
 '(helm-swoop-target-word-face ((t (:background "selectedControlColor" :foreground "Black"))))
 '(highlight ((t nil)))
 ...
 '(mode-line ((t (:background "#373b41" :foreground "white" :box nil))))
 '(org-agenda-structure ((t (:foreground "#1F8DD6" :weight bold :height 1))))
 '(sp-pair-overlay-face ((t (:inherit nil))))
 '(sp-show-pair-match-face ((t (:background "pink"))))
 '(sp-show-pair-mismatch-face ((t (:background "red" :foreground "white"))))
 '(swiper-line-face ((t (:inherit highlight :background "gray95"))))
 '(web-mode-html-tag-face ((t (:foreground "MediumPurple2"))))
 '(whitespace-line ((t (:background "white" :underline "red"))))
 '(whitespace-trailing ((t (:background "pink")))))
