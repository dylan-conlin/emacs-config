...
(custom-set-faces
 ...
 '(helm-ls-git-modified-and-staged-face ((t (:foreground "DarkGoldenrod2"))))
 ...
 '(sp-show-pair-match-face ((t (:background "MistyRose1" :foreground "blue violet"))))
 '(web-mode-html-attr-name-face ((t (:foreground "dark olive green"))))
 '(web-mode-html-tag-face ((t (:background "gray100" :foreground "#33658A"))))
