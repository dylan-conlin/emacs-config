...
(custom-set-faces
 ...
 '(helm-ls-git-modified-and-staged-face ((t (:foreground "green3"))))
 ...
 '(org-block-begin-line ((t (:background "White" :foreground "#555555" :underline "#A7A6AA"))) t)
 '(org-block-end-line ((t (:background "White" :foreground "#555555"))) t)
 '(org-date ((t (:foreground "gray62" :underline nil :height 0.9))))
 '(org-done ((t (:background "White" :foreground "green4" :box nil :weight bold))))
 '(org-level-1 ((t (:background "White" :foreground "dark magenta" :overline nil :weight bold :height 1.3))))
 ...
 '(show-paren-match ((t (:background "white" :foreground "green3"))))
 '(sp-show-pair-match-face ((t (:foreground "green3" :weight bold))))
 '(web-mode-symbol-face ((t (:foreground "DarkOrange3")))))
